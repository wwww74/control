...
{
    public class StandartCalculatorViewModel : ViewModelBase
    {
        ...
        private void EquallyButton_Click(object parameter)
        {
            ...
            LocalDatabase.Instance.AddHistoryItem(new HistoryItemModel { Id = LocalDatabase.Instance.GetAllHistoryItems().Count + 1, Operation = LastOutputText, Result = Text });
        }
        #endregion
